...
export function productFromDb(dbProduct: any): Product {
  return {
    ...
    accessoryCategory: dbProduct.accessory_category || '',
    accessoryCategoryAR: dbProduct.accessory_category_ar || '',
...
export function productToDb(product: Product): any {
  const dbProduct: any = {
    ...
    type: product.type,
    food_category: product.foodCategory || null,
    food_category_ar: product.foodCategoryAR || null,
    accessory_category: product.accessoryCategory || null,
    accessory_category_ar: product.accessoryCategoryAR || null,
    price: product.price,
